...
REQUIRED_SYMBOLS: dict[str, int] = {
    ...
    "SIM_GetPartyManager()": 0x61FB30,
    "SIM_GetVoterManager()": 0x5B9980,
    "SIM_GetPolicyManager()": 0x60FF50,
    ...
    "SIM_Gameplay::NextTurn()": 0x5D0F80,
    "SIM_Gameplay::MultithreadNextTurn()": 0x5CF040,
    "NextTurnThread(void*)": 0x5CFF30,
    "LoadGameThread(void*)": 0x5DCFD0,
    "SIM_ThreadManager::StartNewThread(int (*)(void*), std::string, void (*)())": 0x619E60,
    "SIM_ThreadManager::IsThreadRunning()": 0x619E20,
    ...
    "SIM_Voter::AddToIncomeGroup(SIM_VoterType*, float)": 0x61E4D0,
    "SIM_Voter::PreLoad()": 0x61E3E0,
    "SIM_Voter::CalculateApproval()": 0x61B880,
    "SIM_Voter::ConsiderPartyMembership(int)": 0x61D000,
    "SIM_Voter::CalcEffectOfNeuron(SIM_Neuron*)": 0x61A1D0,
    "SIM_Voter::GetEffectiveApproval()": 0x61C5A0,
    "SIM_Voter::WillVoteForPlayer()": 0x61DB50,
    "SIM_Voter::PreSimulatedNextTurn()": 0x61F3E0,
    "SIM_Voter::NextTurn()": 0x61EF40,
    "SIM_VoterManager::NextTurn()": 0x620570,
    "SIM_VoterManager::PreSimulatedNextTurn()": 0x620510,
    "SIM_VoterManager::AssignVotersToGroups()": 0x620790,
    "SIM_VoterManager::PreJoinParties()": 0x6208E0,
    "SIM_VoterManager::PreCalculateIncome()": 0x620920,
    "SIM_VoterManager::PostLoad()": 0x6209C0,
    "SIM_VoterType::NextTurn()": 0x6223A0,
    "SIM_VoterType::CalculateValue()": 0x622390,
    "SIM_VoterType::AddMostSuitable()": 0x6226D0,
    ...
    "SIM_PollsManager::Initialise()": 0x5FB5B0,
    "SIM_PollsManager::NextTurn()": 0x5FB750,
    "SIM_Complacency::NextTurn()": 0x5BFC10,
    "SIM_PolicyManager::GetPolicy(std::string)": 0x5FA090,
    "SIM_Policy::SetSlider(float)": 0x5F5B70,
    "SIM_Policy::Implement()": 0x5F68F0,
    "SIM_Policy::Cancel()": 0x5F66F0,
    "SIM_PoliticalCapital::SpendPoints(int)": 0x5FADC0,
    "SIM_SaveGame::SaveGame(std::string const&)": 0x608A40,
    "SIM_SaveGame::MultithreadSaveGame(std::string const&)": 0x603260,
